...
func (m *DBMockStore) ListResultTemperature(ctx context.Context, id uuid.UUID) (result []ResultTemperature, err error) {
	args := m.Called(ctx, id)
	return args.Get(0).([]ResultTemperature), args.Error(1)
}
