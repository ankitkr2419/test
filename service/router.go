...
func InitRouter(deps Dependencies) (router *mux.Router) {
	...
	router.HandleFunc("/deckHoming/{deck:[A-B]?}", deckHandler(deps)).Methods(http.MethodGet)
	router.HandleFunc("/syringeHoming/{deck:[A-B]?}", syringeHandler(deps)).Methods(http.MethodGet)
	router.HandleFunc("/syringeModuleHoming/{deck:[A-B]?}", syringeModuleHandler(deps)).Methods(http.MethodGet)
	router.HandleFunc("/magnetHoming/{deck:[A-B]?}", magnetHandler(deps)).Methods(http.MethodGet)
