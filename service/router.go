...
func InitRouter(deps Dependencies) (router *mux.Router) {
	...
	router.HandleFunc("/aspire-dispense", createAspireDispenseHandler(deps)).Methods(http.MethodPost)
	router.HandleFunc("/aspire-dispense/{id}", showAspireDispenseHandler(deps)).Methods(http.MethodGet)
	router.HandleFunc("/aspire-dispense/{id}", updateAspireDispenseHandler(deps)).Methods(http.MethodPut)
