...
export const updateRecipeNameAction = {
  updateRecipeNameInitiated: "UPDATE_RECIPE_NAME_INITIATED",
  updateRecipeNameSuccess: "UPDATE_RECIPE_NAME_SUCCESS",
  updateRecipeNameFailed: "UPDATE_RECIPE_NAME_FAILED",
};
